...
export default function Dashboard() {
 ...
 const {min: minIncome , max: maxIncome} = getMinMax(incomes)
 const {min: minExpense , max: maxExpense} = getMinMax(expenses)
        ...
        <div className="chart-con">
          ...
          <div className="history-con">
              ...
              <div className='salary-item'>
                <p>{minIncome}</p> <p>{maxIncome}</p>
              </div>
              <h2 className='salary-title'>Min <span>Expense</span>Max</h2>
              <div className='salary-item'>
              <p>{minExpense}</p> <p>{maxExpense}</p>
              </div>
          </div>
        </div>
      </InnerLayout>
